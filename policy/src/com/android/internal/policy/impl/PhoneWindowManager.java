...
public class PhoneWindowManager implements WindowManagerPolicy {
    ...
    public void updateSettings() {
        ...
        synchronized (mLock) {
            ...
            if (expandedDesktopHidesNavigationBar() || !mHasNavigationBar) {
                ...
                int navigationBarHeight = Settings.System.getInt(resolver,
                        Settings.System.NAVIGATION_BAR_HEIGHT, 48);
                int navigationBarWidth = Settings.System.getInt(resolver,
                        Settings.System.NAVIGATION_BAR_WIDTH, 48);

                // Height of the navigation bar when presented horizontally at bottom
                mNavigationBarHeightForRotation[mPortraitRotation] =
                mNavigationBarHeightForRotation[mUpsideDownRotation] =
                        navigationBarHeight * DisplayMetrics.DENSITY_DEVICE / DisplayMetrics.DENSITY_DEFAULT;
                mNavigationBarHeightForRotation[mLandscapeRotation] =
                mNavigationBarHeightForRotation[mSeascapeRotation] =
                        navigationBarHeight * DisplayMetrics.DENSITY_DEVICE / DisplayMetrics.DENSITY_DEFAULT;
                ...
                mNavigationBarWidthForRotation[mLandscapeRotation] =
                mNavigationBarWidthForRotation[mSeascapeRotation] =
                        navigationBarWidth * DisplayMetrics.DENSITY_DEVICE / DisplayMetrics.DENSITY_DEFAULT;
            }
        }
