...
public class Constants {
    ...
    public static final int CLEAR_RECENTS_BUTTON_TOP_LEFT = 0;
    public static final int CLEAR_RECENTS_BUTTON_TOP_RIGHT = 1;
    public static final int CLEAR_RECENTS_BUTTON_BOTTOM_LEFT = 2;
    public static final int CLEAR_RECENTS_BUTTON_BOTTOM_RIGHT = 3;
    public static final int CLEAR_RECENTS_BUTTON_DISABLED = 4;
}
