...
public class LinearColorBar extends LinearLayout {
    ...
    private void updateModeAndColors() {
        mRamBarMode = Settings.System.getIntForUser(mContext.getContentResolver(),
                             Settings.System.RECENTS_RAM_BAR_MODE, 0,
                             UserHandle.USER_CURRENT);
        mUsedMemColor = Settings.System.getIntForUser(mContext.getContentResolver(),
                               Settings.System.RECENTS_RAM_BAR_MEM_COLOR, USED_MEM_COLOR,
                               UserHandle.USER_CURRENT);
        mUsedCacheMemColor = Settings.System.getIntForUser(mContext.getContentResolver(),
                                    Settings.System.RECENTS_RAM_BAR_CACHE_COLOR, USED_CACHE_COLOR,
                                    UserHandle.USER_CURRENT);
        mUsedActiveAppsMemColor = Settings.System.getIntForUser(mContext.getContentResolver(),
                                         Settings.System.RECENTS_RAM_BAR_ACTIVE_APPS_COLOR, USED_ACTIVE_APPS_COLOR,
                                         UserHandle.USER_CURRENT);
        mFreeMemColor = Settings.System.getIntForUser(mContext.getContentResolver(),
                                         Settings.System.RECENTS_RAM_BAR_FREE_RAM_COLOR, FREE_COLOR,
                                         UserHandle.USER_CURRENT);
    }
