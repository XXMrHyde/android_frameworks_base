...
public class KeyButtonView extends ImageView {
        ...
        public void run() {
            ...
            if (isPressed()) {
                ...
                if (mLongpressAction != null
                    && DkActions.isActionKeyEvent(mLongpressAction)) {
                    ...
                    if (mCode != 0) {
                        ...
                        if (doIt) {
                            if (mClickAction != null
                                && !DkActions.isActionKeyEvent(mClickAction)) {
    ...
    private OnClickListener mClickListener = new OnClickListener() {
        ...
        public void onClick(View v) {
            DkActions.processAction(mContext, mClickAction, false);
            return;
        }
    };
    ...
    private OnLongClickListener mLongPressListener = new OnLongClickListener() {
        ...
        public boolean onLongClick(View v) {
            DkActions.processAction(mContext, mLongpressAction, true);
            return true;
        }
    };
