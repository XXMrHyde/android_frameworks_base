...
public class Traffic extends TextView {
    ...
    public void updateSettings() {
        ...
        mIsBit = Settings.System.getIntForUser(resolver,
                Settings.System.STATUS_BAR_TRAFFIC_BIT_BYTE, 0,
                UserHandle.USER_CURRENT) == 1;
        mHide = Settings.System.getIntForUser(resolver,
                Settings.System.STATUS_BAR_TRAFFIC_HIDE_INDICATOR, 1,
                UserHandle.USER_CURRENT) == 1;
        ...
        int textColor = Settings.System.getIntForUser(resolver,
                ...
                mDefaultColor, UserHandle.USER_CURRENT);
        mIconColor = Settings.System.getIntForUser(resolver,
                Settings.System.STATUS_BAR_TRAFFIC_ICON_COLOR,
                mDefaultColor, UserHandle.USER_CURRENT);

        mShowDl = (indicator == 1 || indicator == 3) ? true : false;
        mShowUl = (indicator == 2 || indicator == 3) ? true : false;
        ...
        setTextColor(textColor == mDefaultColor ?
