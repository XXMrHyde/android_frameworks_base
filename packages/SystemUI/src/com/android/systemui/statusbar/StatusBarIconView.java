...
public class StatusBarIconView extends AnimatedImageView {
    ...
    static class GlobalSettingsObserver extends ContentObserver {
        ...
        void observe() {
            mContext.getContentResolver().registerContentObserver(
                    Settings.System.getUriFor(Settings.System.STATUS_BAR_COLORIZE_NOTIF_ICONS),
                    false, this);
            mContext.getContentResolver().registerContentObserver(
                    Settings.System.getUriFor(Settings.System.STATUS_BAR_NOTIF_COUNT),
                    false, this);
            mContext.getContentResolver().registerContentObserver(
                    Settings.System.getUriFor(Settings.System.STATUS_BAR_NOTIF_SYSTEM_ICON_COLOR),
                    false, this);
            mContext.getContentResolver().registerContentObserver(
                    Settings.System.getUriFor(Settings.System.STATUS_BAR_NOTIF_COUNT_ICON_COLOR),
                    false, this);
            mContext.getContentResolver().registerContentObserver(
                    Settings.System.getUriFor(Settings.System.STATUS_BAR_NOTIF_COUNT_TEXT_COLOR),
                    false, this);
        }
    ...
    public void updateIconsAndText() {
        ...
        mShowNotifCount = Settings.System.getIntForUser(resolver,
