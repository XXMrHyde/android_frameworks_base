...
public class LocationDetailView extends LinearLayout {
    ...
    protected void onFinishInflate() {
        ...
        mMenuTitle = (TextView) findViewById(android.R.id.title);
    ...
    private void setTextColor(boolean isEnabled) {
        ...
        mHighAccuracy.setTextColor(isEnabled ? textColor : textColorDisabled);
        mBatterySaving.setTextColor(isEnabled ? textColor : textColorDisabled);
        mSensorsOnly.setTextColor(isEnabled ? textColor : textColorDisabled);
    }
}
