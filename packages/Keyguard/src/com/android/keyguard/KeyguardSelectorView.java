...
import com.android.internal.util.darkkat.TorchConstants;
...
public class KeyguardSelectorView extends LinearLayout implements KeyguardSecurityView {
            ...
            if (mStoredTargets == null) {
                ...
                if (target == 0) {
                    ...
                    if (GlowPadView.EMPTY_TARGET.equals(targetUri)) {
                        ...
                        DkActions.processAction(mContext, targetUri, false);
                    }
                }
            }
        }
    ...
    protected void onFinishInflate() {
        ...
        int lockColor = Settings.System.getIntForUser(
                mContext.getContentResolver(),
                Settings.System.LOCKSCREEN_LOCK_COLOR, 0xffffffff,
                UserHandle.USER_CURRENT);

        int dotColor = Settings.System.getIntForUser(
                mContext.getContentResolver(),
                Settings.System.LOCKSCREEN_DOTS_COLOR,  0xffffffff,
                UserHandle.USER_CURRENT);

        int ringColor = Settings.System.getIntForUser(
                mContext.getContentResolver(),
                Settings.System.LOCKSCREEN_TARGETS_RING_COLOR, 0x1affffff,
                UserHandle.USER_CURRENT);

        String lockIcon = Settings.System.getStringForUser(
                mContext.getContentResolver(),
        ...
        if (lockIcon != null && lockIcon.length() > 0) {
            ...
            if (f.exists()) {
                ...
                if (Settings.System.getIntForUser(
                        mContext.getContentResolver(),
                        Settings.System.LOCKSCREEN_COLORIZE_LOCK, 0,
    ...
    public void updateResources() {
        ...
        int frontColor = Settings.System.getIntForUser(
                mContext.getContentResolver(),
                Settings.System.LOCKSCREEN_TARGETS_COLOR, 0xffffffff,
                UserHandle.USER_CURRENT);

        int backColor = frontColor;

        boolean colorizeTargetsIcon = Settings.System.getIntForUser(
                mContext.getContentResolver(),
                Settings.System.LOCKSCREEN_COLORIZE_TARGETS_ICON, 1,
                UserHandle.USER_CURRENT) == 1;
