...
public class ButtonsConstants {
    ...
    // key must fit with the values arrays from Settings
    // to use DkActions.java actions
    public static final String ACTION_HOME                     =
            "**home**";
    public static final String ACTION_BACK                     =
            "**back**";
    public static final String ACTION_SEARCH                   =
            "**search**";
    public static final String ACTION_MENU                     =
            "**menu**";
    public static final String ACTION_MENU_BIG                 =
            "**menu_big**";
    public static final String ACTION_POWER                    =
            "**power**";
    public static final String ACTION_NOTIFICATIONS            =
            "**notifications**";
    public static final String ACTION_QS                       =
            "**quicksettings**";
    public static final String ACTION_RECENTS                  =
            "**recents**";
    public static final String ACTION_SCREENSHOT               =
            "**screenshot**";
    public static final String ACTION_IME                      =
            "**ime**";
    public static final String ACTION_LAST_APP                 =
            "**lastapp**";
    public static final String ACTION_KILL                     =
            "**kill**";
    public static final String ACTION_ASSIST                   =
            "**assist**";
    public static final String ACTION_VIB                      =
            "**ring_vib**";
    public static final String ACTION_SILENT                   =
            "**ring_silent**";
    public static final String ACTION_VIB_SILENT               =
            "**ring_vib_silent**";
    public static final String ACTION_POWER_MENU               =
            "**power_menu**";
    public static final String ACTION_TORCH                    =
            "**torch**";
    public static final String ACTION_EXPANDED_DESKTOP         =
            "**expanded_desktop**";
    public static final String ACTION_THEME_SWITCH             =
            "**theme_switch**";
    ...
    public static final String ACTION_WEATHER_SETTINGS         =
            "**settings_weather**";
    public static final String ACTION_WEATHER_SETTINGS_OPTIONS =
            "**options_weather**";
    public static final String ACTION_WEATHER_SETTINGS_CLICK   =
            "**click_actions_weather**";
    public static final String ACTION_WEATHER_SETTINGS_COLORS  =
            "**colors_weather**";
    ...
    // this shorcut constant is only used to identify
    // if the user selected in settings a custom app
    // after it is choosed intent uri
    // is saved in the ButtonConfig object
    public static final String ACTION_APP                      =
            "**app**";

    public static final String ICON_EMPTY                      =
            "empty";
    public static final String SYSTEM_ICON_IDENTIFIER          =
            "system_shortcut=";
