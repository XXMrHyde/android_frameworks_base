...
public class ActionHelper {
    ...
    private static int getActionSystemIcon(Resources systemUiResources, String clickAction) {
        ...
        } else if (clickAction.equals(ActionConstants.ACTION_ASSIST)) {
            resId = systemUiResources.getIdentifier(
                        SYSTEMUI_METADATA_NAME + ":drawable/ic_sysbar_assist", null, null);
        } else if (clickAction.equals(ActionConstants.ACTION_SEARCH)) {
            resId = systemUiResources.getIdentifier(
                        SYSTEMUI_METADATA_NAME + ":drawable/ic_sysbar_search", null, null);
        } else if (clickAction.equals(ActionConstants.ACTION_VOICE_SEARCH)) {
            resId = systemUiResources.getIdentifier(
                        SYSTEMUI_METADATA_NAME + ":drawable/ic_sysbar_voice_search", null, null);
        ...
        } else if (clickAction.equals(ActionConstants.ACTION_QS_PANEL)) {
            resId = systemUiResources.getIdentifier(
        ...
        } else if (clickAction.equals(ActionConstants.ACTION_MEDIA_PREVIOUS)) {
            resId = systemUiResources.getIdentifier(
                        SYSTEMUI_METADATA_NAME + ":drawable/ic_sysbar_media_previous", null, null);
        } else if (clickAction.equals(ActionConstants.ACTION_MEDIA_NEXT)) {
            resId = systemUiResources.getIdentifier(
                        SYSTEMUI_METADATA_NAME + ":drawable/ic_sysbar_media_next", null, null);
        } else if (clickAction.equals(ActionConstants.ACTION_MEDIA_PLAY_PAUSE)) {
            resId = systemUiResources.getIdentifier(
                        SYSTEMUI_METADATA_NAME + ":drawable/ic_sysbar_media_play_pause", null, null);
        } else {
            resId = systemUiResources.getIdentifier(
                        SYSTEMUI_METADATA_NAME + ":drawable/ic_sysbar_null", null, null);
        }
